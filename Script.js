...
//when 'more' assigned as 'appear' button is clicked (onclick is in html file) text appears
//when 'less' assigned as 'disappear' button is clicked the text is not displayed
function appear() {
...
//swipe fuction: when the image is clicked, it opens up a new window with image preview
function swipe() {
...
//when hamburger menu icon is clicked menu items are shown
...
//form validation 
function validate() {
  //when user input is empty string the alert message is displayed 
